...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ma(){return new Dr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Pa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Na(){return new Dr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pa(),fragmentShader:`
